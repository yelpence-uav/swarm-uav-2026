...
**Son güncelleme:** 30 Ağustos 2026, 13:02 — **A23 ÇALIŞIYOR**: `uart2-pi5` eklendi, i-BUS 130 Hz / 0 hata ölçüldü; eski: A23 eklendi: ikinci RC alıcısı ylp00'a takıldı (pin 29, sinyal ~3 V ölçüldü), overlay bekliyor; eski damga: 29 Ağustos 19:45 — param karşılaştırması saha gününe indirildi
