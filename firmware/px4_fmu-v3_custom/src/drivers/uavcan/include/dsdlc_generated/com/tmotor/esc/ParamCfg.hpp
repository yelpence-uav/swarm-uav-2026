 ...
 *
 * Source file: /home/osmancevik/PX4-Autopilot/src/drivers/uavcan/libdronecan/dsdl/com/tmotor/esc/1033.ParamCfg.uavcan
 */

#ifndef COM_TMOTOR_ESC_PARAMCFG_HPP_INCLUDED
#define COM_TMOTOR_ESC_PARAMCFG_HPP_INCLUDED
...
OVERRIDE_SIGNATURE 0x948F5E0B33E0EDEE
...
com.tmotor.esc.ParamCfg
saturated uint8 esc_index
saturated uint32 esc_uuid
saturated uint16 esc_id_set
...
template <int _tmpl>
struct UAVCAN_EXPORT ParamCfg_
{
    typedef const ParamCfg_<_tmpl>& ParameterType;
    typedef ParamCfg_<_tmpl>& ReferenceType;
    ...
    struct FieldTypes
    {
        ...
        typedef ::uavcan::IntegerSpec< 16, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > esc_id_set;
    ...
    enum
    {
        MinBitLen
            ...
            + FieldTypes::esc_id_set::MinBitLen
    ...
    enum
    {
        MaxBitLen
            ...
            + FieldTypes::esc_id_set::MaxBitLen
    ...
    typename ::uavcan::StorageType< typename FieldTypes::esc_id_set >::Type esc_id_set;
    ...
    enum { DefaultDataTypeID = 1033 };

    static const char* getDataTypeFullName()
    {
        return "com.tmotor.esc.ParamCfg";
    }
...
template <int _tmpl>
bool ParamCfg_<_tmpl>::operator==(ParameterType rhs) const
{
    return
        esc_index == rhs.esc_index &&
        esc_uuid == rhs.esc_uuid &&
        esc_id_set == rhs.esc_id_set &&
...
template <int _tmpl>
bool ParamCfg_<_tmpl>::isClose(ParameterType rhs) const
{
    return
        ::uavcan::areClose(esc_index, rhs.esc_index) &&
        ::uavcan::areClose(esc_uuid, rhs.esc_uuid) &&
        ::uavcan::areClose(esc_id_set, rhs.esc_id_set) &&
...
template <int _tmpl>
int ParamCfg_<_tmpl>::encode(ParameterType self, ::uavcan::ScalarCodec& codec,
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    ...
    res = FieldTypes::esc_id_set::encode(self.esc_id_set, codec,  ::uavcan::TailArrayOptDisabled);
    if (res <= 0)
    {
        return res;
    }
    ...
    res = FieldTypes::esc_save_option::encode(self.esc_save_option, codec,  tao_mode);
    return res;
}

template <int _tmpl>
int ParamCfg_<_tmpl>::decode(ReferenceType self, ::uavcan::ScalarCodec& codec,
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    (void)self;
    (void)codec;
    ...
    res = FieldTypes::esc_id_set::decode(self.esc_id_set, codec,  ::uavcan::TailArrayOptDisabled);
    if (res <= 0)
    {
        return res;
    }
    ...
    res = FieldTypes::esc_save_option::decode(self.esc_save_option, codec,  tao_mode);
    return res;
}
 ...
 */
template <int _tmpl>
::uavcan::DataTypeSignature ParamCfg_<_tmpl>::getDataTypeSignature()
{
    ::uavcan::DataTypeSignature signature(0x948F5E0B33E0EDEEULL);

    FieldTypes::esc_index::extendDataTypeSignature(signature);
    FieldTypes::esc_uuid::extendDataTypeSignature(signature);
    FieldTypes::esc_id_set::extendDataTypeSignature(signature);
 ...
 * Final typedef
 */
typedef ParamCfg_<0> ParamCfg;

namespace
{

const ::uavcan::DefaultDataTypeRegistrator< ::com::tmotor::esc::ParamCfg > _uavcan_gdtr_registrator_ParamCfg;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::com::tmotor::esc::ParamCfg >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::com::tmotor::esc::ParamCfg::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::com::tmotor::esc::ParamCfg >::stream(Stream& s, ::com::tmotor::esc::ParamCfg::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "esc_index: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_index >::stream(s, obj.esc_index, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_uuid: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_uuid >::stream(s, obj.esc_uuid, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_id_set: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_id_set >::stream(s, obj.esc_id_set, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_ov_threshold: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_ov_threshold >::stream(s, obj.esc_ov_threshold, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_oc_threshold: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_oc_threshold >::stream(s, obj.esc_oc_threshold, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_ot_threshold: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_ot_threshold >::stream(s, obj.esc_ot_threshold, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_acc_threshold: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_acc_threshold >::stream(s, obj.esc_acc_threshold, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_dacc_threshold >::stream(s, obj.esc_dacc_threshold, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_rotate_dir: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_rotate_dir >::stream(s, obj.esc_rotate_dir, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_timing: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_timing >::stream(s, obj.esc_timing, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_signal_priority >::stream(s, obj.esc_signal_priority, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_led_mode: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_led_mode >::stream(s, obj.esc_led_mode, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_can_rate: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_can_rate >::stream(s, obj.esc_can_rate, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_fdb_rate: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_fdb_rate >::stream(s, obj.esc_fdb_rate, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "esc_save_option: ";
    YamlStreamer< ::com::tmotor::esc::ParamCfg::FieldTypes::esc_save_option >::stream(s, obj.esc_save_option, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::com::tmotor::esc::ParamCfg::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::com::tmotor::esc::ParamCfg >::stream(s, obj, 0);
    return s;
}
...
#endif // COM_TMOTOR_ESC_PARAMCFG_HPP_INCLUDED