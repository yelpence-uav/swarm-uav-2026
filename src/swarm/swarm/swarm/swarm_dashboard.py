...
class SwarmDashboard(Node):
    def __init__(self):
        ...
        self.last_msg_time = {
            i: time.time() for i in self.drones
        }  # Son mesaj gelme zamanları
    ...
    def position_callback(self, msg, drone_id):
        ...
        self.last_msg_time[drone_id] = (
            time.time()
        )  # Veri geldiği an kronometreyi sıfırla
    ...
    def timer_callback(self):
        ...
        for i in self.drones:
            ...
            print(
                f"Drone {i} | {pos['x']:>8.2f} | {pos['y']:>10.2f} | {pos['z']:>11.2f} | {status}"
            )
